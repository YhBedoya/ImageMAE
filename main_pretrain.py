...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/content/drive/MyDrive/Data Science and Engineering - PoliTo2/Thesis/models/mae-main/tiny-imagenet-200/', type=str,  #TODO: data dir
                        help='dataset path')
